...
if (PermDialogSelected > -1) then {
	...
	[_building,true,true] execVM "dayz_code\admintools\tools\AdminBuild\adminBuild.sqf";
};
...
if (TempDialogSelected > -1) then {
	...
	[_building,true,false] execVM "dayz_code\admintools\tools\AdminBuild\adminBuild.sqf";
};
