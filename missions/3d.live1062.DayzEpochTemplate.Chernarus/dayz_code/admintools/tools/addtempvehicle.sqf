...
EAT_PVEH_vehSpawn spawn EAT_vehSpawn;

"Spawned a vehicle." call dayz_rollingMessages;

// Tool use logger
if(EAT_logMinorTool) then {
	EAT_PVEH_usageLogger = format["%1 %2 -- has added a temporary vehicle: %3",name _player,(_player getVariable["playerUID", 0]),_vehtospawn];
