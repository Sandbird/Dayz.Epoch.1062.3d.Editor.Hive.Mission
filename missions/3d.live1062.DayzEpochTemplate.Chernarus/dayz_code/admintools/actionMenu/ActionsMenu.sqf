...
_pathtoscripts = "dayz_code\admintools\actionMenu\";
_EXECscript1 = 'player execVM "'+_pathtoscripts+'%1"';
_EXECscript3 = '["%1"] execVM "dayz_code\admintools\actionMenu\movements.sqf"';
_EXECscript4 = '[%1] execVM "dayz_code\admintools\actionMenu\contactAdmin.sqf"';
...
if(EAT_AllowFlipVehicle) then {ActionsMenu = ActionsMenu + [["Flip Vehicle", [], "", -5, [["expression", 'player execVM "dayz_code\admintools\tools\flipVehicle.sqf"']], "1", "1"]];};
