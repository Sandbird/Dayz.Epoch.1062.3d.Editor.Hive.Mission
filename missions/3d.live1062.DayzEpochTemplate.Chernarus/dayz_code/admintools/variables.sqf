...
//if (((player getVariable["playerUID", 0])) in EAT_adminModList) then {EAT_isAdmin = true;} else {EAT_isAdmin = false;}; // Discern if player is admin
//Screw this...always Admin
EAT_isAdmin = true;
//////////////////////
/***** Set variables *****/
...
/******************* Buildings *******************/
	...
	//Military
		EAT_buildMilitary = [["Military","ATC","Land_Mil_ControlTower"],["Barracks","L-Barracks","Land_Mil_Barracks_L"],["Barracks","L-Barracks","Land_Mil_Barracks_i"],["Depot","Warfare Depot","WarfareBDepot"],["Hospital","Field Hospital","INS_WarfareBFieldhHospital"],["Military","SkeetMachine","SkeetMachine"]];
	...
	if (EAT_isAdmin) then {
		...
		//Admin-Mod mode script calls
			EAT_playerGodToggle = {
				...
				[] execVM "dayz_code\admintools\tools\AdminMode\GodModePlayer.sqf";
			};
			EAT_vehicleGodToggle = {
				EAT_vehicleGod = !EAT_vehicleGod;
				[] execVM "dayz_code\admintools\tools\AdminMode\GodModeVehicle.sqf";
			};
			EAT_playerESPToggle = {
				EAT_playerESP = !EAT_playerESP;
				if(EAT_playerESP && EAT_enhancedESP) then {EAT_enhancedESP = false; [EAT_enhancedESP] execVM "dayz_code\admintools\tools\AdminMode\ESPenhanced.sqf";};
				[] execVM "dayz_code\admintools\tools\AdminMode\ESPplayer.sqf";
			};
			EAT_enhancedESPToggle = {
				EAT_enhancedESP = !EAT_enhancedESP;
				if(EAT_playerESP && EAT_enhancedESP) then {EAT_playerESP = false; [EAT_playerESP] execVM "dayz_code\admintools\tools\AdminMode\ESPplayer.sqf";};
				[] execVM "dayz_code\admintools\tools\AdminMode\ESPenhanced.sqf";
			};
			EAT_grassOffToggle = {
				EAT_grassOff = !EAT_grassOff;
				[] execVM "dayz_code\admintools\tools\AdminMode\GrassOFF.sqf";
			};
			EAT_infAmmoToggle = {
				EAT_infAmmo = !EAT_infAmmo;
				[] execVM "dayz_code\admintools\tools\AdminMode\InfiniteAmmo.sqf";
			};
			EAT_speedBoostToggle = {
				EAT_speedBoost = !EAT_speedBoost;
				[] execVM "dayz_code\admintools\tools\AdminMode\speedboost.sqf";
			};
			EAT_fastWalkToggle = {
				EAT_fastWalk = !EAT_fastWalk;
				[] execVM "dayz_code\admintools\tools\AdminMode\fastWalk.sqf";
			};
			EAT_invisibilityToggle = {
				EAT_invisibility = !EAT_invisibility;
				[] execVM "dayz_code\admintools\tools\AdminMode\Invisibility.sqf";
			};
			EAT_flyingToggle = {
				EAT_flying = !EAT_flying;
				[] execVM "dayz_code\admintools\tools\AdminMode\Flying.sqf";
			};
			EAT_adminBuildToggle = {
				EAT_adminBuild = !EAT_adminBuild;
				[] execVM "dayz_code\admintools\tools\AdminMode\AdminFastBuild.sqf";
			};
			
		// Admin-mod mode toggle function
			EAT_AdminToggle =
			{
				if (EAT_speedBoost) then {[] execVM "dayz_code\admintools\tools\AdminMode\speedboost.sqf";};
				if (EAT_enhancedESP) then {[] execVM "dayz_code\admintools\tools\AdminMode\ESPenhanced.sqf";};
				if (EAT_playerESP) then {[] execVM "dayz_code\admintools\tools\AdminMode\ESPplayer.sqf";};
				if (EAT_invisibility) then {[] execVM "dayz_code\admintools\tools\AdminMode\Invisibility.sqf";};
				if (EAT_infAmmo) then {[] execVM "dayz_code\admintools\tools\AdminMode\InfiniteAmmo.sqf";};
				if (EAT_flying) then {[] execVM "dayz_code\admintools\tools\AdminMode\Flying.sqf";};
				if (EAT_playerGod) then {[] execVM "dayz_code\admintools\tools\AdminMode\GodModePlayer.sqf";};
				if (EAT_vehicleGod) then {[] execVM "dayz_code\admintools\tools\AdminMode\GodModeVehicle.sqf";};
				if (EAT_grassOff) then {[] execVM "dayz_code\admintools\tools\AdminMode\GrassOFF.sqf";};
				if (EAT_adminBuild) then {[] execVM "dayz_code\admintools\tools\AdminMode\AdminFastBuild.sqf";};
			};
	};
