...
switch (_item) do {
	case "ItemBandage": {
		_id = [0,0,0,[player,"ItemBandage"]] execVM "dayz_code\medical\bandage.sqf";
	};
	case "ItemMorphine": {
		_id = [0,0,0,[player]] execVM "dayz_code\medical\morphine.sqf";
	};
	case "equip_woodensplint": {
		_id = [0,0,0,[player,"equip_woodensplint"]] execVM "dayz_code\medical\brokeBones.sqf";
	};
	case "ItemPainkiller": {
	...
	//Antibiotic's system
	case "ItemAntibiotic": {
		_id = [player,"ItemAntibiotic"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic1": {
		_id = [player,"ItemAntibiotic1"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic2": {
		_id = [player,"ItemAntibiotic2"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic3": {
		_id = [player,"ItemAntibiotic3"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic4": {
		_id = [player,"ItemAntibiotic4"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic5": {
		_id = [player,"ItemAntibiotic5"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	case "ItemAntibiotic6": {
		_id = [player,"ItemAntibiotic6"] execVM "dayz_code\medical\antibiotics.sqf";
	};
	...
	case "ItemSepsisBandage": {
		_id = [0,0,0,[player,"ItemSepsisBandage"]] execVM "dayz_code\medical\bandage.sqf";
	};
