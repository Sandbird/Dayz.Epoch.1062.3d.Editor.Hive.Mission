...
if(_NVOn == "ON") exitwith
{
	...
	s_pz_player1 = player addAction ["Vision", "dayz_code\actions\pzombie\pz_vision.sqf", [], 0, false, true, "nightVision", "_this == _target"];
};
...
s_pz_player2 = player addAction ["Vision", "dayz_code\actions\pzombie\pz_vision.sqf", [], 0, false, true, "nightVision", "_this == _target"];
