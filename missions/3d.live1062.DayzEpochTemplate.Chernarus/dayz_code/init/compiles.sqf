...
//debug_monitor =					compile preprocessFileLineNumbers "dayz_code\actions\debug_monitor.sqf";
	...
	BIS_fnc_areEqual 				= compile preprocessFileLineNumbers "dayz_code\system\functions\variables\fn_areEqual.sqf";
 	...
 	BIS_fnc_setPitchBankMine = 	compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fnc_SetPitchBankYaw.sqf";
	...
	player_updateGui = switch (toLower DZE_UI) do {
		case "dark": {compile preprocessFileLineNumbers "dayz_code\compile\player_updateGuiDark.sqf";};
		case "epoch": {compile preprocessFileLineNumbers "dayz_code\compile\player_updateGuiEpoch.sqf";};
		case "vanilla": {compile preprocessFileLineNumbers "dayz_code\compile\player_updateGui.sqf";};
	};
	...
	player_forceSave = compile preprocessFileLineNumbers "dayz_code\compile\player_forceSave.sqf";
	//player_destroyTent = compile preprocessFileLineNumbers "dayz_code\actions\player_destroyTent.sqf";
	...
	object_dismantle = compile preprocessFileLineNumbers "dayz_code\actions\object_dismantle.sqf";
	...
	//actions
	userActionConditions = compile preprocessFileLineNumbers "dayz_code\actions\userActionConditions.sqf";
	player_addToolbelt = compile preprocessFileLineNumbers "dayz_code\actions\player_addToolbelt.sqf";
	player_addtoBack = compile preprocessFileLineNumbers "dayz_code\actions\player_addtoBack.sqf";
	player_reloadMag = compile preprocessFileLineNumbers "dayz_code\actions\player_reloadMags.sqf";
	player_consume = compile preprocessFileLineNumbers "dayz_code\actions\player_consume.sqf";
	player_emptyContainer = compile preprocessFileLineNumbers "dayz_code\actions\player_emptyContainer.sqf";
	player_useMeds = compile preprocessFileLineNumbers "dayz_code\actions\player_useMeds.sqf";
	player_useAttchment = compile preprocessFileLineNumbers "dayz_code\actions\player_useAttchment.sqf";
	player_attachAttachment = compile preprocessFileLineNumbers "dayz_code\actions\player_attachAttachment.sqf";
	player_removeAttachment = compile preprocessFileLineNumbers "dayz_code\actions\player_removeAttachment.sqf";
	player_fillWater = compile preprocessFileLineNumbers "dayz_code\actions\water_fill.sqf";
	player_makeFire = compile preprocessFileLineNumbers "dayz_code\actions\player_makefire.sqf";
	player_chopWood = compile preprocessFileLineNumbers "dayz_code\actions\player_chopWood.sqf";
	player_mineStone = compile preprocessFileLineNumbers "dayz_code\actions\player_mineStone.sqf";
	if (DZE_modularBuild) then {
		player_build = compile preprocessFileLineNumbers "dayz_code\actions\modular_build.sqf";
		snap_build = compile preprocessFileLineNumbers "dayz_code\actions\snap_build.sqf";
	} else {
	...
	player_buildVanilla = compile preprocessFileLineNumbers "dayz_code\actions\player_buildVanilla.sqf";
	player_buildPlaceables = compile preprocessFileLineNumbers "dayz_code\actions\player_buildPlaceables.sqf";
	fn_buildCamera = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_buildCamera.sqf";
	object_build = compile preprocessFileLineNumbers "dayz_code\actions\object_build.sqf";
	object_upgradeFireplace = compile preprocessFileLineNumbers "dayz_code\actions\object_upgradeFireplace.sqf";
	player_wearClothes = compile preprocessFileLineNumbers "dayz_code\actions\player_wearClothes.sqf";
	player_dropWeapon = compile preprocessFileLineNumbers "dayz_code\actions\player_dropWeapon.sqf";
	object_pickup = compile preprocessFileLineNumbers "dayz_code\actions\object_pickup.sqf";
	//player_sleep = compile preprocessFileLineNumbers "dayz_code\actions\player_sleep.sqf";
	player_combineMag = compile preprocessFileLineNumbers "dayz_code\actions\player_combineMags.sqf";
	player_combineAntibiotics = compile preprocessFileLineNumbers "dayz_code\actions\player_combineAntibiotics.sqf";
	player_createquiver = compile preprocessFileLineNumbers "dayz_code\actions\player_createQuiver.sqf";
	player_fillquiver = compile preprocessFileLineNumbers "dayz_code\actions\player_fillQuiver.sqf";
	//player_takearrow = compile preprocessFileLineNumbers "dayz_code\actions\player_takeArrow.sqf";
	call compile preprocessFileLineNumbers "dayz_code\actions\player_switchWeapon.sqf";
	//player_goFishing = compile preprocessFileLineNumbers "dayz_code\actions\player_goFishing.sqf";
	player_gather = compile preprocessFileLineNumbers "dayz_code\actions\player_gather.sqf";
	player_fixBottle = compile preprocessFileLineNumbers "dayz_code\actions\player_fixBottle.sqf";
	player_tearClothes = compile preprocessFileLineNumbers "dayz_code\actions\player_tearClothes.sqf";
	//object_remove = compile preprocessFileLineNumbers "dayz_code\actions\remove.sqf";
	player_fixHatchet = compile preprocessFileLineNumbers "dayz_code\actions\player_fixTools.sqf";
	player_sharpen = compile preprocessFileLineNumbers "dayz_code\actions\player_sharpen.sqf";
	player_butcher = compile preprocessFileLineNumbers "dayz_code\actions\gather_meat.sqf";
	player_pushPlane = compile preprocessFileLineNumbers "dayz_code\actions\player_pushPlane.sqf";
	//player_repairVehicle = compile preprocessFileLineNumbers "dayz_code\actions\repair_vehicle.sqf";
	//player_salvageVehicle = compile preprocessFileLineNumbers "dayz_code\actions\salvage_vehicle.sqf";
	...
	player_craftItemVanilla = compile preprocessFileLineNumbers "dayz_code\actions\player_craftItemVanilla.sqf";
	...
	player_copyKey = compile preprocessFileLineNumbers "dayz_code\actions\player_copyKey.sqf";
	player_deathBoard =	compile preprocessFileLineNumbers "dayz_code\actions\list_playerDeathsAlt.sqf";
	...
	player_loadCrate = compile preprocessFileLineNumbers "dayz_code\actions\player_loadCrate.sqf";
	player_lockVault = compile preprocessFileLineNumbers "dayz_code\compile\player_lockVault.sqf";
	player_packVault = compile preprocessFileLineNumbers "dayz_code\compile\player_packVault.sqf";
	...
	player_surrender = compile preprocessFileLineNumbers "dayz_code\actions\player_surrender.sqf";
	...
	player_unlockVault = compile preprocessFileLineNumbers "dayz_code\compile\player_unlockVault.sqf";
	player_upgradeVehicle =	compile preprocessFileLineNumbers "dayz_code\compile\player_upgradeVehicle.sqf";
	PlotGetFriends = compile preprocessFileLineNumbers "dayz_code\actions\plotManagement\plotGetFriends.sqf";
	PlotNearbyHumans = compile preprocessFileLineNumbers "dayz_code\actions\plotManagement\plotNearbyHumans.sqf";
	PlotAddFriend = compile preprocessFileLineNumbers "dayz_code\actions\plotManagement\plotAddFriend.sqf";
	PlotRemoveFriend = compile preprocessFileLineNumbers "dayz_code\actions\plotManagement\plotRemoveFriend.sqf";
	...
	MaintainPlot = compile preprocessFileLineNumbers "dayz_code\actions\maintain_area.sqf";
	DoorGetFriends = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\doorGetFriends.sqf";
	DoorNearbyHumans = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\doorNearbyHumans.sqf";
	DoorAddFriend = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\doorAddFriend.sqf";
	DoorRemoveFriend = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\doorRemoveFriend.sqf";
	player_manageDoor = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\initDoorManagement.sqf";
	player_enterCode = compile preprocessFileLineNumbers "dayz_code\actions\doorManagement\player_enterCode.sqf";	
	FNC_check_access = compile preprocessFileLineNumbers "dayz_code\compile\fn_check_access.sqf";
	...
	if (!DZE_ConfigTrader) then {call compile preprocessFileLineNumbers "dayz_code\compile\player_hiveTrading.sqf";};
	// recent murders menu
	call compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_murderBoard.sqf";
};

//Both
my_BIS_fnc_DirTo = 	compile preprocessFileLineNumbers "custom\fireworks\fnc_dirTo.sqf";	
...
fnc_veh_handleKilled = compile preprocessFileLineNumbers "dayz_code\compile\veh_handleKilled.sqf";
fnc_veh_handleRepair = compile preprocessFileLineNumbers "dayz_code\compile\veh_handleRepair.sqf";	//process the hit as a NORMAL damage (useful for persistent vehicles)
...
fnc_Obj_FenceHandleDam = compile preprocessFileLineNumbers "dayz_code\compile\fence_handleDam.sqf";
...
//Trying to fix the keyboard not working in editor
...
fnc_hats = {
	...
	switch (_class) do
	{
		...
		default { 
			call fnc_remove_hat;
			hat = createVehicle [_class,position _player,[],0,"NONE"];
			hat setVariable ["ObjectID","1",true];
			hat setVariable ["ObjectUID","1",true];
			hat attachTo [_player,_pos,"Pelvis"];
			if (_class == "MetalBucket") then {
				hat setVectorUp [vectorUp hat select 0,vectorUp hat select 1,-(vectorUp hat select 2)];
			};
			_player reveal hat;
		};
	};
...
if (isServer) then {
	...
	server_spawnTraders = compile preprocessFile "dayz_server\compile\server_spawnTraders.sqf";
