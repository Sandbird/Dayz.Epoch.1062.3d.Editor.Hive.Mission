...
_base="dayz_code\system\scheduler\";
...
_list execVM ("dayz_code\system\scheduler\scheduler.sqf"); //fsm doesnt run in editor

diag_log [ diag_tickTime, __FILE__, "Scheduler Client started"];