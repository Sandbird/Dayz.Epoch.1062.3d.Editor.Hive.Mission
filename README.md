...
- Copy everything inside ***"Arma2OA root folder"*** into your root Arma2OA folder.
  ...
  - The ***tbbmalloc - tbbmalloc_x64.dll*** files are provided by [extDB3](extdb). They shouldnt interfere with your normal game, but they are needed for the mission to be able to connect to your MySQL server. (Make a backup of your original ones if you want, just be safe.)
